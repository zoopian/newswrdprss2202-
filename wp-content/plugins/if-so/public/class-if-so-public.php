...
class If_So_Public {
	...
	public function enqueue_scripts() {
        ...
        $isPagesVisitedOn = (int) !\IfSo\Services\PluginSettingsService\PluginSettingsService::get_instance()->removePageVisitsCookie->get();
...
SCR;
    ...
    public function set_ifso_group_cookie(){
        if(isset($_REQUEST['ifsoGroup']) && !empty($_REQUEST['ifsoGroup'])){
            ...
            \IfSo\PublicFace\Helpers\CookieConsent::get_instance()->set_cookie('ifsoGroup',$grp,time()+60*60*24*365*3,'/'); //Set a cookie to identify a member of a group(3 years)
    ...
    public function update_visit_count($ajax=false){
        ...
        \IfSo\PublicFace\Helpers\CookieConsent::get_instance()->set_cookie($cookie_name, $num_of_visits, $expiration, "/");
    }
