<?php 
function newsair_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'newsair_page_menu_args' );
function newsair_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new newsair_walker_page_menu;
...
class newsair_walker_page_menu extends Walker_Page{
