...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () { 
        ...
        if(jQuery("#newsair_social_limit").val()==5)
        {
           jQuery(".customizer_newsair_social_upgrade_to_pro").show();
            return false;
        }
        else
        {
           var total_social_sections=parseInt(jQuery("#newsair_social_limit").val())+1;
           jQuery("#newsair_social_limit").val(total_social_sections)
           if(jQuery("#newsair_social_limit").val()>5)
            {
                jQuery(".customizer_newsair_social_upgrade_to_pro").hide();
            }
        }
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        var total_icon= parseInt(jQuery("#newsair_social_limit").val())-1;
       jQuery("#newsair_social_limit").val(total_icon);
