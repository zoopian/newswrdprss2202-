<?php
if ( ! class_exists( 'Ascendoor_News_Posts_Grid_Widget' ) ) {
	/**
	 * Adds Ascendoor_News_Posts_Grid_Widget Widget.
	 */
	class Ascendoor_News_Posts_Grid_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ascendoor_news_grid_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-section style-1',
				'description' => __( 'Retrive Posts Grid Widgets', 'ascendoor-news' ),
			);
			parent::__construct(
				'ascendoor_news_magazine_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'ascendoor-news' ),
				$ascendoor_news_grid_widget_ops
			);
		}
