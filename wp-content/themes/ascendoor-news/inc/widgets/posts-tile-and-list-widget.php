<?php
if ( ! class_exists( 'Ascendoor_News_Posts_Tile_And_List_Widget' ) ) {
	/**
	 * Adds Ascendoor_News_Posts_Tile_And_List_Widget Widget.
	 */
	class Ascendoor_News_Posts_Tile_And_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ascendoor_news_tile_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-list-section style-1',
				'description' => __( 'Retrive Tile And List Widgets', 'ascendoor-news' ),
			);
			parent::__construct(
				'ascendoor_news_magazine_tile_list_widget',
				__( 'Ascendoor Tile And List Widget', 'ascendoor-news' ),
				$ascendoor_news_tile_list_widget_ops
			);
		}
