<?php
if (!function_exists('newstag_header_menu_section')) :
/**
 *  Header
 *
 * @since Newstag
 *
 */
function newstag_header_menu_section()
{
                  ...
                  <!-- navbar-toggle -->
                   <!-- navbar-toggle -->
                      <button class="navbar-toggler x collapsed" type="button" data-bs-toggle="collapse"
                       ...
                       aria-label="<?php esc_attr_e('Toggle navigation','newstag'); ?>">
...
add_action('newstag_action_header_menu_section', 'newstag_header_menu_section', 6);