<?php
if (!function_exists('newstag_front_page_banner_section')) :
  /**
   *
   * @since Newstag
   *
   */
  function newstag_front_page_banner_section() {
...
add_action('newstag_action_front_page_main_section_1', 'newstag_front_page_banner_section', 40); 