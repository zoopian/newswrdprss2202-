...
if( !class_exists( 'Newsmatic_Theme_Info' ) ) :
    class Newsmatic_Theme_Info {
        ...
        function __construct() {
            ...
            if( isset( $_GET['newsmatic_update_notice_dismiss'] ) ) {
                update_option( 'newsmatic_update_notice_dismiss', '1.2.7' );
            }
            //Add the theme page
            ...
            if( ! $this->newsmatic_disable_admin_notices ) :
                ...
                add_action( 'admin_notices', array( $this, 'add_update_admin_notice' ) );
        ...
        function theme_info_scripts($hook) {
            if( ! $this->newsmatic_disable_admin_notices ) :
                ...
                $newsmatic_update_notice_dismiss = get_option( 'newsmatic_update_notice_dismiss' );
                if( ! $newsmatic_welcome_notice_dismiss || ! $newsmatic_update_notice_dismiss ) {
        ...
        /**
         * Add upgrade release notice to the admin dashboard
         *
         * @since 1.0.0
         */
        function add_update_admin_notice() {
            if ( isset( $_GET['activate'] ) ) unset( $_GET['activate'] );
            $newsmatic_upgrade_notice_dismiss = get_option( 'newsmatic_update_notice_dismiss' );
            if( $newsmatic_upgrade_notice_dismiss == '1.2.7' ) {
                return;
            }
        ...
        ?>
            <div class="newsmatic-welcome-notice newsmatic-update-notice notice notice-info is-dismissible">
                <div class="notice-content-wrap">
                    <div class="notice-content">
                        <h2><?php echo sprintf( '%1s <span>Version 1.2.7</span> %2s', esc_html__( 'Newsmatic', 'newsmatic' ), esc_html__( 'is here', 'newsmatic' ) ); ?></h2>
                        <p><?php esc_html_e( 'We have been always looking forward to fulfill our users needs and requirements. So, to overcome some sorts of requirements and issue on our previous version. We have pushed 1.2.7 version with great new features. Check it out now', 'newsmatic' ); ?></p>
                        <ul class="features-list">
                            <li class="feature-item"><?php echo esc_html__( 'Banner layout five', 'newsmatic' ); ?></li>
                            <li class="feature-item"><?php echo esc_html__( 'Image size select control', 'newsmatic' ); ?></li>
                            <li class="feature-item"><?php echo esc_html__( 'Image ratio size slider control', 'newsmatic' ); ?></li>
                        </ul>
                        <div class="notice-actions">
                            <a class="button button-primary load-customize hide-if-no-customize" target="_blank" href="<?php echo esc_url( get_admin_url( '', 'customize.php' ) ); ?>"><?php esc_html_e( 'Try It Now', 'newsmatic' ); ?></a>
                            <a class="button button-primary load-customize hide-if-no-customize" target="_blank" href="<?php echo esc_url( '//blazethemes.com/newsmatic-1-2-7-big-new-update/'); ?>"><?php esc_html_e( 'See Whats New', 'newsmatic' ); ?></a>
                            <a class="button button-primary load-customize hide-if-no-customize" target="_blank" href="<?php echo esc_url( '//youtu.be/RoWSd_fkEes'); ?>"><?php esc_html_e( 'Watch Video', 'newsmatic' ); ?></a>
                            <a class="button button-primary load-customize hide-if-no-customize" target="_blank" rel="nofollow" href="<?php echo esc_url( '//blazethemes.com/theme/newsmatic-pro/'); ?>"><?php esc_html_e( 'Upgrade To Pro', 'newsmatic' ); ?></a>
                        </div>
                    </div>
                    <div class="screenshot-wrap">
                        <img src="<?php echo esc_url( get_template_directory_uri() . '/inc/admin/assets/update-banner.png' ); ?>" height="200" height="200"/>
                    </div>
                </div><!-- .notice-content-wrap -->
                <div class="notice-dismiss-button">
                    <a class="" href="<?php echo esc_attr( '?newsmatic_update_notice_dismiss=1' ); ?>"><?php esc_html_e( 'Dismiss this notice', 'newsmatic' ); ?></a>
                </div>
            </div>
            <?php
        }
